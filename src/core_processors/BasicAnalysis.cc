...
BasicAnalysis::BasicAnalysis() : Processor("BasicAnalysis") {
...
void BasicAnalysis::processRunHeader( LCRunHeader* run) { 
//    _nRun++ ;
} 



void BasicAnalysis::processEvent( LCEvent * evt ) { 
...
void BasicAnalysis::check( LCEvent * evt ) { 
    // nothing to check here - could be used to fill checkplots in reconstruction processor
}



void BasicAnalysis::end(){ 
    _rootfile->Write();
}
