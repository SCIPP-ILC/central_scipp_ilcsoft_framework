...
//****************************************************SECOND*****PASS******************************************************************************
	    ...
	    int count = 0;
            ...
            for(MCParticle* particle : had){
                ...
                if(abs(cos)<0.5){
                    //scipp_ilc::transform_to_lab(mom[0], mom[3], mom[0], mom[3]);
		  //cout << "J iter : "<< getMag(hadronic) << endl;                    
		  hadronic[0]+=mom[0];    
                    hadronic[1]+=mom[1];    
                    hadronic[2]+=mom[2];    
                    hadronic[3]+=mom[3];    
	    ...
	    //cout << "jane " << hadronic[3] << " : " << hadronic[2] << endl;
		...
		//cout << "jane : " << hadronic[3] << " : " << hadronic[2] << " : " << pred_e[2] << endl;
		...
		//cout << "jane : " << pred_e[0] << ":" << pred_e[1] << ": " << pred_e[3] << endl;
		...
		//cout << endl<< "J " << pred_e_pos[0] << " : " << pred_e_pos[1] << endl;
                //get hit status
