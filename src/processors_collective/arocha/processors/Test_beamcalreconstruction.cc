...
#include "Test_beamcalreconstruction.h"
...
Test_beamcalreconstruction Test_beamcalreconstruction;

static TFile* _rootfile;
static TProfile* _radeff;
static int _detected_num = 0;

Test_beamcalreconstruction::Test_beamcalreconstruction() : Processor("Test_beamcalreconstruction") {
...
void Test_beamcalreconstruction::init() { 
...
void Test_beamcalreconstruction::processRunHeader( LCRunHeader* run) { 
//    _nRun++ ;
} 



void Test_beamcalreconstruction::processEvent( LCEvent* signal_event ) { 
...
void Test_beamcalreconstruction::check( LCEvent * evt ) { 
    // nothing to check here - could be used to fill checkplots in reconstruction processor
}



void Test_beamcalreconstruction::end(){ 
