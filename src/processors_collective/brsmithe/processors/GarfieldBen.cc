...
GarfieldBen GarfieldBen;

TFile* _rootfile;
TH2F* _hitmap;


GarfieldBen::GarfieldBen() : Processor("GarfieldBen") {
...
void GarfieldBen::processRunHeader( LCRunHeader* run) { 
//    _nRun++ ;
} 



void GarfieldBen::processEvent( LCEvent * evt ) { 
...
void GarfieldBen::check( LCEvent * evt ) { 
    // nothing to check here - could be used to fill checkplots in reconstruction processor
}



void GarfieldBen::end(){ 
    _rootfile->Write();
}
