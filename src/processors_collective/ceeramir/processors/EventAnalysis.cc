...
EventAnalysis::EventAnalysis() : Processor("EventAnalysis") {
...
void EventAnalysis::processRunHeader( LCRunHeader* run) { 
//    _nRun++ ;
} 



void EventAnalysis::processEvent( LCEvent * evt ) { 
...
void EventAnalysis::check( LCEvent * evt ) { 
    // nothing to check here - could be used to fill checkplots in reconstruction processor
}



void EventAnalysis::end(){ 
    _rootfile->Write();
}
