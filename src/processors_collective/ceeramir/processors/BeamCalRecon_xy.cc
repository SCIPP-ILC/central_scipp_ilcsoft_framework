...
void BeamCalRecon_xy::FillRadiusThetaTable(bool truth_value, double radius, double phi_in_radian){
    ...
    //comenting out the 'for' loop compiles, otherwise it doesn't

    int a = _arr_height;
    int b = 5;

    //    cout << "arr height: " << _arr_height << endl;
    //    cout << "a: " << a << endl;
    ...
    cout << "rad theta w/ cut: " << _RadTheta_wCut[phi_index][rad_index] << endl;
    cout << "rad theta w/ bgd: " << _RadTheta_wBgd[phi_index][rad_index] << endl;
    cout << "\n";*/    
    
    //  cout << "before: " << _RadTheta_wCut[phi_index][rad_index];
    //  cout << "\t after" <<   _RadTheta_wCut[phi_index][rad_index] << endl;
...
void BeamCalRecon_xy::init() { 
    ...
    _1DRadHitsSigE_wCut = new TH1F("radHitsWCut","",150,0,300);
    _1DRadHitsSigE_wBGD = new TH1F("radHitsWBgd","",150,0,300);
    _1DRadHitsSigE_wDiv = new TH1F("radHitsWDiv","",150,0,300);
...
void BeamCalRecon_xy::end(){
    ...
    */
    ...
    //    FillRadiusThetaTable
    //    PrintRadiusThetaTable();
    //    PrintRadiusThetaTable();
