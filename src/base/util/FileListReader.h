...
namespace marlin{
   ...
   *
   * @author F. Gaede, DESY
   * @version $Id: FileListReader.h,v 1.3 2005-10-11 12:56:28 gaede Exp $ 
   */
  
  class FileListReader : public DataSourceProcessor {
    
  public:

    FileListReader() ;

    virtual FileListReader*  newProcessor() ;
